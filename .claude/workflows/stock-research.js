...
const synthesis = await agent(
  ...
  `   - 若動能訊號方向明確，列出動能策略下的進場方式（例如順勢突破前波高/前波低、或站上/跌破特定均線）、停損（動能型停損可用跌破近期均線或前一根K棒低點，不強制要求像結構型框架那樣的ATR倍數，但仍需寫出具體點位)、以及動能反轉的出場訊號（例如MACD死叉、RSI跌破50、跌破近期均線）。\n` +
  `   - 若技術指標本身互相矛盾或本輪出現跨來源大幅分歧（例如RSI不同來源差距超過10點），要明確寫「動能訊號本身不一致，此策略本輪不適用」，不要硬湊方向。\n` +
  `   - 結尾務必寫一段風險提醒：動能策略比結構確認型更早進場、也更早停損出場，換手更頻繁，在盤整或訊號矛盾時容易被連續小停損（whipsaw）打，且不像上面的框架會等事件公布或籌碼確認，本質上是用「更快反應」換「更高的假訊號風險」，兩套框架給出的方向可能不同，讀者需自行選擇適合自己風險偏好與交易頻率的一套，不是「動能策略比較積極所以比較對」。\n` +
  `   ## 風險管理備註\n` +
